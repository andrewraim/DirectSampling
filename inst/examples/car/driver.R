# To get CARBayes and CARBayesdata from CRAN archive:
# devtools::install_url("https://cran.r-project.org/src/contrib/Archive/CARBayes/CARBayes_1.6.tar.gz")
# devtools::install_url("https://cran.r-project.org/src/contrib/Archive/CARBayesdata/CARBayesdata_2.2.tar.gz")
...
direct_control = get_direct_control(N = 30, max_rejects = 5000)
...
set.seed(1234)
gibbs_out = gibbs(y, X, S, A, init, prior, control, fixed = fixed)
print(gibbs_out)
