#ifndef DIRECT_SAMPLING_BASE_DISTRIBUTION_H
#define DIRECT_SAMPLING_BASE_DISTRIBUTION_H
...
public:
	// Evaluate the density of this distribution on x. If log = true, return
	// the log-density.
	virtual double density(double x, bool log = false) const = 0;
	
	// Return the probability of the open interval (x1,x2): P(x1 < X < x2)
	virtual double pr_interval(double x1, double x2, bool log) const = 0;
